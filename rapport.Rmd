...
La présence des personnes noires dans les études allant de master à doctorat s'explique principalement par la mise en place de quotats par les universités (discrimination positive) dès les années 1960. De plus, la minorité afro-américaine est la plus grosse minorité des Etats-Unis, ce qui signifie qu'elle a un poids électoral indéniable. Ce n'est pas le cas des populations natives qui n'ont pas pu bénéficier de cette discrimination positive. 
