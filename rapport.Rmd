...
On constate que les personnes racisées sont très présentes dans certains secteurs, et dans des proportions toujours similaires en fonction des ethnies, caucasiens compris.
(non ? on regardera ensemble mais j'pense il y a des choses à analyser) (à voir si on laisse ou pas parce que c’est pas très intéressant du coup). 
!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!
