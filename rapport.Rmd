...
ggplot(industry, aes(y = major_industry_recode, fill = race)) +
  geom_bar() +
  labs(title = "Répartition ethnique dans les différents secteurs d'activité", x = "Nombre", y = "Type de branche", fill = "Ethnie")
```
...
ggplot(industry2, aes(y = major_industry_recode, fill = race)) +
  geom_bar() +
  labs(title = "Répartition des personnes racisées dans les secteurs d'activité"x = "Nombre", y = "Type de branche", fill = "Ethnie")
```
...
no_other <- data %>%
    ...
    ggplot(no-other, aes(y = fct_rev(fct_infreq(country_of_birth_self)))) +
  geom_bar() +
