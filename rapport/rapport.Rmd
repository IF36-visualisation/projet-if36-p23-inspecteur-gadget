...
Quelques pays comme le Mexique semblent néanmoins se distinguer du fait de sa proximité avec les Etats-Unis (frontière commune). Cette information peut être mise en perspective avec les débats des années 2010 sur la construction d'un mur à la frontière entre les Etats-Unis et le Mexique pour endiguer le flux migratoire venant du Mexique mais aussi de l'Amérique latine.  
...
La forte présence de population née en Allemagne pourrait elle, être expliquée par une émigration durant et post-2nde guerre mondiale.
